...
function formatDate(iso) {
	// `todayMST()` returns "YYYY-MM-DD". Parsing that via new Date() treats it
	// as UTC midnight which, rendered back in America/Denver, shifts to the
	// previous day (the "Apr 15 on Apr 16 morning" stale-date bug). Parse the
	// y/m/d components directly when we have a plain date string.
